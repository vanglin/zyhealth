<template lang="html">
  <main>
    ...
    <section v-show='curindex == 0'>
      <div>
        <div class="downtime" @click="showpickerday()">
    ...
    <section v-show='curindex != 0'>
      <div>
        <div class="downtime" @click="showpicker()">
          <span>{{downtext}}</span>
          <img src="../../assets/images/down.png" alt="">
        </div>
      </div>
    ...
    <section>
      <van-actionsheet v-model="showday">
        <van-datetime-picker
          v-model="currentDate"
          type="date"
          @cancel="onCancelDay"
      ...
      .then(response => {
        ...
        if (this.healthres.length > 0) {
          if (this.healthres.length == 1) {
            ...
            this.shangwures = this.healthres[1];
            this.xiawures = this.healthres[0];
